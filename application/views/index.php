...
<body class="creative-lp">
                    ...
                    <div class="row flex-center pt-5 mt-3">
                        <div class="col-md-12 col-lg-6 text-center text-md-left margins">
                            <div class="dark-grey-text">
                                <h1 class="top-h1 top-head title mt-md-5 mt-lg-0 font-weight-bold wow fadeIn" data-wow-delay="0.3s">
                                    <strong>
                                      Innovative<br>
                                      Connections<br>
                                      Meaningful<br>
          ...
          <div class="container">
            ...
            <section id="solution" class="section about mt-5 mb-5 py-3 wow fadeIn" data-wow-delay="0.2s">
                ...
                <div class="row pt-2 mt-5">
                  ...
                  <div class="row pt-2 mt-5">
                    <div class="col-md-3 text-center wow slideInUp mb-3" data-wow-delay="0.6s">
              ...
              <section id="opportunity" class="section about mt-5 mb-5 py-3 wow fadeIn" data-wow-delay="0.2s">
                  ...
                  <div class="row mt-1 mb-4">
                      ...
                      <div class="col-md-6 mb-4">
                          ...
                          <!-- Stepers Wrapper -->
                          <ul class="stepper stepper-vertical body-rem">
          ...
          <div class="container">
            ...
            <section id="investor" class="section about mt-5 mb-5 py-3 wow fadeIn" data-wow-delay="0.2s">
                ...
                <div class="row pt-2 mt-5">
                    ...
                    <div class="row pt-2 mt-5">
                      <div class="col-xs-3 wow fadeIn text-center mb-3" data-wow-delay="0.8s">
                      ...
                      <div class="col-xs-12 wow fadeIn text-center mt-5 pt-3" data-wow-delay="0.8s">
    ...
    var myLineChart = new Chart(ctxL, {
      ...
      data: {
        ...
        datasets: [{
            label: "Tinder",
            data: [0, 3000, 4000, 10000, 20000, 35000, 55000, 70000, 85000, 100000, 120000, 130000, 140000, 165000, 190000, 220000],
            backgroundColor: [
              'rgba(0, 0, 0, 0)',
            ],
            borderColor: [
          ...
          {
            label: "LOOVOO",
            data: [0, 3000, 4000, 8000, 10000, 14000, 19000, 22000, 24000, 30000, 40000, 44000, 50000, 55000, 57000, 60000],
            backgroundColor: [
              'rgba(0, 0, 0, 0)',
            ],
            borderColor: [
          ...
          {
            label: "Bumble",
            data: [0, 0, 0, 2000, 3000, 4000, 6000, 8000, 10000, 11000, 15000],
            backgroundColor: [
              'rgba(0, 0, 0, 0)',
            ],
            borderColor: [
